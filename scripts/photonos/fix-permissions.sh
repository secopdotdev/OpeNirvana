...
#
# PhotonOS variant. Bind-mount ownership rules are OS-independent (chown/chmod),
# so this is functionally identical to the Ubuntu version; it lives here so the
# PhotonOS script set is self-contained.
#
...
#
# Usage:
#   sudo bash scripts/photonos/fix-permissions.sh
#
